...
xdescribe('Edit Credit Card Component', () => {
	describe('after initialization', () => {
		...
		beforeEach(async(() => {
			TestBed.configureTestingModule({
				declarations:[EditAuthorizedotnetCardComponent],
				imports: [IonicModule.forRoot(EditAuthorizedotnetCardComponent), TranslateModule.forRoot()],
				providers :[
				...
				.overrideTemplate(EditAuthorizedotnetCardComponent, '<div><script>var Spreedly = {init:function(){},on:function(){}};</script></div>');
		}));

		beforeEach(() => {
			fixture = TestBed.createComponent(EditAuthorizedotnetCardComponent);
		...
		it('should be created', () => {
			expect(component instanceof EditAuthorizedotnetCardComponent).toBe(true);
		});
	});
	...
	describe('methods', () => {
		...
		let editCreditCardComponent:EditAuthorizedotnetCardComponent;
		...
		beforeEach(() => {
			...
			editCreditCardComponent = new EditAuthorizedotnetCardComponent(navController, navParams, formBuilder, creditCardService, messagingService, translationService);
		});
