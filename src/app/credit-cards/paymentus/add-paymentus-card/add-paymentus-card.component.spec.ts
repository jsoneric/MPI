...
xdescribe('Add Credit Card Component', () => {
	xdescribe('after initialization', () => {
		let fixture, component;

		beforeEach(async(() => {
			TestBed.configureTestingModule({
				declarations:[AddPaymentusCardComponent],
				imports: [IonicModule.forRoot(AddPaymentusCardComponent), TranslateModule.forRoot()],
				providers :[
		...
		beforeEach(() => {
			fixture = TestBed.createComponent(AddPaymentusCardComponent);
		...
		it('should be created', () => {
			expect(component instanceof AddPaymentusCardComponent).toBe(true);
		});
	});
	...
	describe('methods', () => {
		...
		let addCreditCardComponent:AddPaymentusCardComponent;
		...
		beforeEach(() => {
			...
			addCreditCardComponent = new AddPaymentusCardComponent(navController, formBuilder, creditCardService, messagingService, cardio, translationService);
		});
