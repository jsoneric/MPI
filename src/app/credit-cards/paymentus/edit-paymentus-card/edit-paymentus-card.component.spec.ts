...
xdescribe('Edit Credit Card Component', () => {
	describe('after initialization', () => {
		...
		beforeEach(async(() => {
			TestBed.configureTestingModule({
				declarations:[EditPaymentusCardComponent],
				imports: [IonicModule.forRoot(EditPaymentusCardComponent), TranslateModule.forRoot()],
				providers :[
				...
				.overrideTemplate(EditPaymentusCardComponent, '<div><script>var Spreedly = {init:function(){},on:function(){}};</script></div>');
		}));

		beforeEach(() => {
			fixture = TestBed.createComponent(EditPaymentusCardComponent);
		...
		it('should be created', () => {
			expect(component instanceof EditPaymentusCardComponent).toBe(true);
		});
	});
	...
	describe('methods', () => {
		...
		let editCreditCardComponent:EditPaymentusCardComponent;
		...
		beforeEach(() => {
			...
			editCreditCardComponent = new EditPaymentusCardComponent(navController, navParams, formBuilder, creditCardService, messagingService, translationService);
		});
